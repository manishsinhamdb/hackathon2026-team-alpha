"""Skeleton tests for Data Seeding Agent — verify NOT_IMPLEMENTED stubs and envelope validation."""
import json
import pytest
...
def test_generate_seed_not_implemented():
    resp = _invoke("generate_seed", {"poc_id": POC, "code_version": "v001", "mode": "generate",
                                     "inputs": {"schema_design_key": "k1", "query_patterns_key": "k2"}})
