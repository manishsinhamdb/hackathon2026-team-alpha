"""Skeleton tests for API Agent — verify NOT_IMPLEMENTED stubs and envelope validation."""
import json
import pytest
...
def _invoke(tool: str, params: dict):
    ...
    env = Envelope.request(poc_id=POC, run_id=new_id("run"), caller="coding_orchestrator",
                           agent="api_agent", tool=tool, params=params, task_id=TASK)
...
def test_generate_api_not_implemented():
    resp = _invoke("generate_api", {"poc_id": POC, "code_version": "v001", "mode": "generate",
